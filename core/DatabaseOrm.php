...
class DatabaseOrm
{
    ...
    public function __construct(string $modelClass)
    {
        ...
        $this->table = 'bitrix.'.$this->resolveTableName($modelClass);
...
//        $this->loadRelations($entity);
     ...
     */
    private function insert(object $entity, array $columns, array $values)
    {
     ...
     */
    private function update(object $entity, string $primaryKey, $primaryValue, array $columns, array $values)
    {
        $setParts = [];
